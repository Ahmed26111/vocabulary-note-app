...
import 'package:vocabulary_note_app/ui%20layer/words_details_screen.dart';
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => WordsDetailsScreen(wordModel: wordModel),
          ),
        );
      },
      child: Container(
